...
{
    [TestFixture()]
    public class IT3_VelocityCalculator_VelocityAnalyzer
    {
        ...
        public void AnalyzeVelocity_AnalyzesVelocityForoneTrack_VelocityIsCorrect(int numberOfFlightsInNewestTracks, int secondsBetweenTimestamps, int firstXCoordinate, int secondXCoordinate, int firstYCoordinate, int secondYCoordinate, double expectedVelocity)
        {
            ...
            _velocityAnalyzer.AnalyzeVelocity(OldestTracks, NewestTracks);
